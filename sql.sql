...
insert  into `parkingset`(`name`,`parkingId`,`available`,`curVehicle`,`lastRecordTime`,`setId`) values ('aa','1','true','bbb',15345345,3),('pbkjs','1','true','京212312',1496148770,4),('3F','1','true',NULL,1496148930,6);
